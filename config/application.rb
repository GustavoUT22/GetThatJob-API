  ...
  class Application < Rails::Application
    ...
    config.middleware.insert_before 0, Rack::Cors do
      allow do
        ...
        resource "/recruiters/applications/:id", headers: :any, methods: [:get, :patch, :options]
        ...
        resource "/jobs/:id", headers: :any, methods: [:get, :delete, :patch, :options]
        ...
        resource "/follows", headers: :any, methods: [:get,:post, :options]
        resource "/follows/:id", headers: :any, methods: [:delete, :options]
      end
    end
